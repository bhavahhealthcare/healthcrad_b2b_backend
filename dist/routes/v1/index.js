...
import { fetchCurrentUser, loginUser, registerUser, verifyOTP, resendOtp, deleteUserWithPharmacy, loginAdmin, updateUserDetails, addAddress, updateAddress, deleteAddress, useWalletBalance } from "../../controller/user-controller.js";
...
import { get, getAll, createMedicine, deleteMedicine, updateMedicine, getMedicinesByManufacturer, updateDiscountAndPriceByManufacturer, insertManyMedicines, search, getManufacturersByCategory } from "../../controller/medicine-controller.js";
import { toggleWishlist, getWishlistController } from "../../controller/wishlist-controller.js";
...
import { getOrderSummary, createOrder, updateOrderStatus, getOrder, getDeliveredOrders, getNewOrdersWithinLast12Hours, checkOrderStatus } from "../../controller/booking-controller.js";
...
router.get("/medicines-by-manufacturer/:manufacturer", getMedicinesByManufacturer);
...
router.put("/update-discount/:manufacturer", checkAuth, checkAdmin, updateDiscountAndPriceByManufacturer);
router.post("/bulk-insert-medicine", checkAuth, checkAdmin, insertManyMedicines);
...
router.get("/orders/new-last-12-hours", checkAuth, checkAdmin, getNewOrdersWithinLast12Hours);
