...
export const getMedicinesByManufacturer = async (req, res) => {
  try {
    ...
    const medicines = await medicineService.getMedicinesByManufacturer(manufacturer);
    return res.status(200).json({
      data: medicines,
      success: true,
    ...
    console.error('Error in getMedicinesByManufacturer controller method:', error);
    return res.status(500).json({
      data: null,
      success: false,
