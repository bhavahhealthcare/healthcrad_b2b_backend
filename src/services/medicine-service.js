...
class MedicineService {
  ...
  async updateDiscountAndPriceByManufacturer(manufacturer, newDiscount) {
    try {
        const { result, previousDiscount } = await this.medicineRepository.updateDiscountByManufacturer(manufacturer, newDiscount);
        ...
        return { result, message: `Successfully updated discount and prices for manufacturer: ${manufacturer}` };
    } catch (error) {
